    ...
    >
      ...
      <div className="relative w-full overflow-hidden">
        <img
          ...
          height={1280}
          fetchPriority="high"
          className="mx-auto block h-auto w-[72%] max-w-[300px] object-contain object-center"
        />
    ...
    >
      ...
      <div className="relative mx-auto max-w-md px-6">
        ...
        <div className="mt-6 text-center">
          ...
          {/* Stacked avatars — Andrea Valdiri leading */}
          <div className="mt-6 flex items-center justify-center">
            <div className="flex items-center -space-x-2">
              <img
                ...
                style={{
                  ...
                  boxShadow: "0 0 14px rgba(201,168,76,0.75), 0 0 28px rgba(201,168,76,0.35)",
                }}
                loading="lazy"
              />
...
function HeroTransformation() {
  ...
  const RootIcon = () => (
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke={GOLD} strokeWidth="1.4">
      <path d="M12 3c-3 4-5 7-5 10a5 5 0 0 0 10 0c0-3-2-6-5-10z" />
      <path d="M10 7l1 1M14 7l-1 1M9 12l1 1M15 12l-1 1" strokeLinecap="round" />
    </svg>
  );
  const SparkIcon = () => (
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke={GOLD} strokeWidth="1.4">
      <path d="M12 3c-3 4-5 7-5 10a5 5 0 0 0 10 0c0-3-2-6-5-10z" />
      <path d="M12 8l0.6 1.4L14 10l-1.4 0.6L12 12l-0.6-1.4L10 10l1.4-0.6z" fill={GOLD} stroke="none" />
    </svg>
  );
  const DropIcon = () => (
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke={GOLD} strokeWidth="1.4">
  ...
  const benefits = [
    { icon: <RootIcon />, title: "FORTALECE", sub: "desde la raíz" },
    { icon: <SparkIcon />, title: "ESTIMULA", sub: "el crecimiento" },
    { icon: <DropIcon />, title: "NUTRE", sub: "profundamente" },
  ];
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(120% 80% at 30% 20%, #3a1d4d 0%, #1a0a2e 55%, #0e0520 100%)",
        color: IVORY,
      }}
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[520px] grid-cols-12 gap-0 px-0 pt-6">
        {/* MODEL — left column, extends full height */}
        <div className="col-span-5 relative">
          <img
            ...
            style={{
              maskImage:
                "linear-gradient(90deg, black 60%, rgba(0,0,0,0.85) 82%, transparent 100%)",
              WebkitMaskImage:
                "linear-gradient(90deg, black 60%, rgba(0,0,0,0.85) 82%, transparent 100%)",
              minHeight: 420,
            }}
          ...
          <div
            className="absolute left-2 right-1 bottom-3 text-center"
            style={{ zIndex: 3 }}
          >
            <p
              style={{
        ...
        <div className="col-span-7 pl-1 pr-4 pb-4">
          {/* Logo + wordmark */}
          <div className="flex flex-col items-center pt-1">
            <svg viewBox="0 0 60 60" width="42" height="42" aria-hidden>
              <defs>
              ...
              {/* laurel */}
              <path
                d="M12 32 Q4 22 12 12 M48 32 Q56 22 48 12"
                stroke="url(#crestG)"
                strokeWidth="1.4"
                fill="none"
              />
              <path
                d="M14 36 Q10 42 14 48 M46 36 Q50 42 46 48"
                stroke="url(#crestG)"
                strokeWidth="1.2"
                fill="none"
              />
              {/* crown */}
              <path
                d="M22 14 L26 20 L30 12 L34 20 L38 14 L37 22 L23 22 Z"
                fill="url(#crestG)"
              />
              {/* face silhouette */}
              <circle cx="30" cy="34" r="8" fill="url(#crestG)" opacity="0.85" />
              <path d="M30 42 Q22 48 24 56 L36 56 Q38 48 30 42" fill="url(#crestG)" opacity="0.85" />
            </svg>
            <div
              className="font-display"
              style={{
          ...
          >
            Un sistema completo para un
            <br />
            cabello más fuerte, abundante
            <br />
            y lleno de vida.
          </p>
              ...
              <li key={b.title} className="flex items-center gap-3">
                <span
                  ...
                  style={{
                    ...
                    height: 40,
                    border: `1px solid ${GOLD}55`,
                    background: "rgba(212,168,94,0.06)",
                    flexShrink: 0,
                  }}
                >
                  {b.icon}
      ...
      {/* Product trio — centered under content */}
      <div className="relative mx-auto w-full max-w-[520px] px-6 mt-2">
        <img
          src={trioImg.url}
          alt="Shampoo, Acondicionador y Tónico Rapunceles"
          className="block w-full h-auto"
          style={{
            filter:
              "drop-shadow(0 22px 30px rgba(0,0,0,0.55)) drop-shadow(0 0 24px rgba(232,201,138,0.15))",
            mixBlendMode: "normal",
          }}
        />
      </div>
      ...
      <div className="mx-auto w-full max-w-[520px] px-3 pb-3">
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(30,15,45,0.9), rgba(15,6,25,0.95))",
            border: `1px solid ${GOLD}55`,
            boxShadow: `0 0 0 1px ${GOLD}22 inset, 0 12px 30px rgba(0,0,0,0.4)`,
          }}
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex flex-col items-center justify-center rounded-xl px-3 py-2"
            style={{
              background: `linear-gradient(180deg, ${GOLD_SOFT}, ${GOLD_DEEP})`,
              color: PURPLE_DEEP,
              border: `1px solid ${GOLD}`,
        ...
        {/* Trust row */}
        <div
          className="mt-3 flex items-start justify-between gap-2 px-1"
          style={{
            fontSize: "0.6rem",
            letterSpacing: "0.14em",
            color: "#C9BAD1",
        ...
        >
          <TrustItem
            icon={
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke={GOLD} strokeWidth="1.4">
                <path d="M12 3l8 3v6c0 5-4 8-8 9-4-1-8-4-8-9V6l8-3z" />
              </svg>
            }
            text={<>COMPRA<br/>SEGURA</>}
          />
          <Divider />
          <TrustItem
            icon={
          ...
          <TrustItem
            ...
            text={<>ENVÍO GRATIS<br/>A TODA COLOMBIA</>}
          />
        </div>
      </div>
    </section>
...
function TrustItem({ icon, text }: { icon: React.ReactNode; text: React.ReactNode }) {
  return (
    <div className="flex items-center gap-1.5 flex-1 justify-center text-center">
      {icon}
      <span style={{ fontWeight: 500, lineHeight: 1.25 }}>{text}</span>
    </div>
  );
